...
export default defineConfig({
    ...
    build: {
        lib: {
            ...
            entry: resolve(__dirname, "resources/js/main-pidinst.js"),
            name: "pidManagerPidinst",
            // the proper extensions will be added
            fileName: "build-pidinst",
            // important to generate Immediately Invoked Function Expression as output
            // this can be easily loaded via script tag and ensure it will be executed immediately
