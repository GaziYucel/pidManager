...
class PidinstWorkflow
{
    ...
    public function execute(string $hookName, array $args): void
    {
        ...
        $templateParameters = [
            ...
            'pidinsts' => json_encode($pidinstRepo->getPidinsts($publication))
        ];
        $templateMgr->assign($templateParameters);

        $templateMgr->display($this->plugin->getTemplateResource("pidinst/pidinstWorkflow.tpl"));
    }
}
